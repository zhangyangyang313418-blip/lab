...
function markerDefinitions(entries) {
  ...
  return [
    ...
    marker("_PT_SGS_PROTO_PHASE", "SGS", "$A$6:$R$6"),
    marker("_PT_SGS_PROTO_GROUP", "SGS", "$A$7:$R$7"),
    marker("_PT_SGS_PROTO_HEADER", "SGS", "$A$8:$R$8"),
    marker("_PT_SGS_PROTO_DATA", "SGS", "$A$9:$R$9"),
    marker("_PT_SGS_PROTO_TOTAL", "SGS", "$A$27:$R$27"),
    marker("_PT_CTI_DYNAMIC_START", "华测", "$A$6"),
    marker("_PT_CTI_DYNAMIC_END", "华测", `$R$${end("华测").match(/\d+/)[0]}`),
    marker("_PT_CTI_PROTO_PHASE", "华测", "$A$6:$R$6"),
    marker("_PT_CTI_PROTO_GROUP", "华测", "$A$7:$R$7"),
    marker("_PT_CTI_PROTO_HEADER", "华测", "$A$8:$R$8"),
    marker("_PT_CTI_PROTO_DATA", "华测", "$A$9:$R$9"),
    marker("_PT_CTI_PROTO_TOTAL", "华测", "$A$27:$R$27"),
    marker("_PT_SUBO_DYNAMIC_START", "苏勃", "$A$6"),
    marker("_PT_SUBO_DYNAMIC_END", "苏勃", `$R$${end("苏勃").match(/\d+/)[0]}`),
    marker("_PT_SUBO_PROTO_PHASE", "苏勃", "$A$6:$R$6"),
    marker("_PT_SUBO_PROTO_GROUP", "苏勃", "$A$7:$R$7"),
    marker("_PT_SUBO_PROTO_HEADER", "苏勃", "$A$8:$R$8"),
    marker("_PT_SUBO_PROTO_DATA", "苏勃", "$A$9:$R$9"),
    marker("_PT_SUBO_PROTO_TOTAL", "苏勃", "$A$27:$R$27"),

    marker("_PT_COMPARE_DYNAMIC_START", "费用对比", "$A$9"),
    marker("_PT_COMPARE_DYNAMIC_END", "费用对比", "$R$37"),
    marker("_PT_COMPARE_PROTO_PHASE", "费用对比", "$A$9:$R$9"),
    marker("_PT_COMPARE_PROTO_HEADER", "费用对比", "$A$11:$R$11"),
    marker("_PT_COMPARE_PROTO_DATA", "费用对比", "$A$12:$R$12"),
