...
function createMlaPlan(environmentItems: EditableTestItem[], projectCode: string): EnvironmentPlanSheet {
  ...
  const commonGroups: EnvironmentPlanGroup[] = [
    ...
    createGroup("mla-group-d8", "Group D-8", groupD8Items, withRowsWhenItemsExist(groupD8Items, [
      withQuantityOverride(createRow("d8-optical", "Optical Test", "7", "1-12"), "12"),
      withQuantityOverride(createRow("d8-l1l4", "L1&L4 Performance Evaluation & Functional Evaluation", "3", "1-12"), "12"),
      ...
      withQuantityOverride(createRow("d8-post-l1l4", "L1&L4 Performance Evaluation & Functional Evaluation", "3", "1-12"), "9"),
      withQuantityOverride(createRow("d8-post-optical", "Optical Test", "3", "1-12"), "9"),
      withQuantityOverride(createRow("d8-post-l6", "L6-photo&xray", "3", "1-12"), "9"),
    ]), { totalSampleQty: "12", totalDurationDays: "14" }),
